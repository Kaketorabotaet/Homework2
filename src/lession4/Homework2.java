...
//            } else if (vegetables & sausage == true) {
//                System.out.println("Оливьешечка, ням, ням, ням!");
//            } else if (chicken & eggs == true) {
//                System.out.println("Оливьешечка, ням, ням, ням!");
//            } else if (vegetables == true) {
//                System.out.println("Готовим овощной салат, как ты, после армии!");
//            }else {
//                System.out.println("Деньгов нет, есть нема, приходите завтра");
//            }
//    }
//    }
...
//    // Написать к ним конструктор, сеттеры, геттеры.
        animalName animal1 = new animalName("Gloria");
